...
/*
    Hier werden neue Spiele registriert.

    Beispiel für ein späteres Spiel:

    "cosmic-run":
        "games/cosmic-run/cosmic-run.html"
*/

const games = {

    fruityway:
        "games/fruityway/fruityway.html"
...
/*
    ...
    Echtes Discord OAuth2 darf nicht einfach
    nur mit JavaScript im Browser umgesetzt werden.

    Später kommt hier unser Backend-Endpunkt hin,
    z.B.:

    window.location.href =
        "/auth/discord";

    Der Server übernimmt dann den sicheren
    Discord-Login.

    Bis dahin zeigen wir eine Information an.
*/
...
openModal(`
    ...
    <p>
        Du hast 5 Runden geschafft!
        Wähle ein kostenloses Item.
    </p>
...
/*
    Falls Fruityway gerade geöffnet ist,
    wird das Inventar ebenfalls aktualisiert.
*/

if (
    typeof window.refreshInventory ===
    "function"
) {
...
() => {
    ...
    /*
        Der eigentliche Spielfeld-Reset
        wird später von fruityway.js
        übernommen.
    */
